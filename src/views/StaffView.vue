...
<template>
  ...
  <div class="container member">
    <div class="board-member row mb-4" v-for="item,idx in memberList">
      <div class="col-md-3">
        <img :src="item.image" alt="Board Member Photo" class="img-fluid rounded" />
      </div>
      <div class="col-md-9">
        <h2 class="member-name text-primary">{{ item.name }}</h2>
        <p class="member-title text-muted fst-italic">{{ item.title }}</p>
